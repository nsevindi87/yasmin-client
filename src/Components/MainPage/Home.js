  ...
  return (
    <div className='container-fluid'>
      <div className="row h-100" >
        <div className="col-6 ps-5" style={{height:"100vh",paddingTop:"25rem", backgroundColor:"#5fafff"}} >
...
— Abraham Lincoln</p>
        ...
        <div className="col-6" style={{paddingTop:"15rem", paddingLeft:"2rem", backgroundColor:"#5fafff"}}>
          <img src={image} class="img-fluid" alt="Image" style={{width:"400rem", minWidth:"60rem",}}/>
        </div>
      </div>
