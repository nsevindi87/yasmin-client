...
const GreenList = () => {
  const { greenList,getWordsList,redAsideList, handleDelete,handleEdit, handleClose, show, setInputValue, inputValue, handleUpdate, handleDeleteList } = useContext(wordsContext)
  ...
  return (
    <>
      <Container>
        <Row className='mt-5'>
          <Col>
            <h1 className='text-center shadow mb-4 rounded'>Green List</h1>
