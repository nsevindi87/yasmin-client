...
const RedList = () => {
  const { redList,redAsideList,  getWordsList, handleDelete,handleEdit, handleClose, show, setInputValue, inputValue, handleUpdate, handleDeleteList } = useContext(wordsContext)
